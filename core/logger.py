...
def mask_sensitive_data(data: Any) -> Any:
    """Mask sensitive data like API keys, passwords, tokens, etc.
    
    Args:
        data: The data to mask.

    Returns:
        The masked data as REDACTED.
    """
...
logger = init_logger(
    project=os.getenv('BRAINTRUST_PROJECT', 'My Project'), api_key=os.getenv('BRAINTRUST_API_KEY')
)
